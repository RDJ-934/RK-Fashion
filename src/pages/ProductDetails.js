  ...
  return <section className='pt-32 pb-12 lg:py-32 h-screen flex items-center'>
    <div className='container mx-auto '>
      ...
      <div className='flex flex-1 justify-center items-center mb-8 lg:mb-0'>
        <img className='max-w-[225px]' src={image} alt=''/>
      </div>

      <div className='flex-1 text-center lg:text-left '>
        <h1 className='text-[23px] font-semibold mb-2 max-w-[400px] mx-auto lg:mx-0'>{title}</h1>
        <div className='text-xl text-gray-500 font-medium mb-6 '>$ {price}</div>
        <p className='text-[17px] mb-8'>{description}</p>
